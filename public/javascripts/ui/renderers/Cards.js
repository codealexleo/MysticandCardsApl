...
class PlayerBoard extends PlayerHand {
    ...
    getDragCardBoardPos (cardX, cardY) {
        ...
        let boardPosHeight = Card.height + 10;
...
class OppCard {
    ...
    draw(x, y) {
        ...
        let centerX = (canvas.width - OppCard.width) / 2;
        let centerY = (canvas.height - OppCard.height) / 2;
    
        image(GameInfo.images.cardBacks[this.rarity - 1], centerX, centerY, 150, 200);
    }
}
